...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        **kwargs,
        ...
        if "my_output_path" in kwargs.keys():
            output_json = {
                "child_attn_head": [attn.tolist() for attn in encoder_outs[0]["child_attn_head"]],
                "parent_attn_head": [attn.tolist() for attn in encoder_outs[0]["parent_attn_head"]],
            }
            with open(kwargs["my_output_path"], "w") as f:
