...
class DatasetConfig(FairseqDataclass):
    ...
    validate_after_epochs: int = field(
        default=0, metadata={"help": "dont validate until reaching this many epochs"}
    )
...
class GenerationConfig(FairseqDataclass):
    ...
    # my config
    print_encoder_out: bool = field(
        default=False,
        metadata={"help": "print encoder out"},
    )
    print_decoder_out: bool = field(
        default=False,
        metadata={"help": "print decoder out"},
    )
    extra_output_dir: Optional[str] = field(
        default=None,
        metadata={"help": "extra output dir"},
    )
